...
class Error(Dialog):
    def __init__(self,label: str = "Error", msg: str = None, callback=None, abort_callback=None) -> None:
        super().__init__(tag=f"{self.tag_prefix}.window.error",
                         width=450,
                         height=120,
                         no_close=False,
                         callback=callback,
        ...
        dpg.add_image(f"{self.tag_prefix}.icon.error", parent=self.tag, pos=(10,25), width=70, height=70)
